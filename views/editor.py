...
class LexerTikZ(QsciLexerTeX):
	...
	def keywords(self, keyword_set):
		...
		if keyword_set == 1:
			keywords += ' ' + ' '.join(globals.editor.TIKZ_KEYWORDS)
		return keywords
	...
	def defaultColor(self, style):
		...
		if style == LexerTikZ.Default: # LaTeX comments (without leading %)
			color = QColor(globals.editor.EDITOR_COMMENTS_COLOR)
		elif style == LexerTikZ.Special: # Symbols ()[]<>=
			color = QColor(globals.editor.EDITOR_SYMBOLS1_COLOR)
		elif style == LexerTikZ.Group: # Symbols {}$
			color = QColor(globals.editor.EDITOR_SYMBOLS2_COLOR)
		elif style == LexerTikZ.Symbol: # Leading % of LaTeX comments
			color = QColor(globals.editor.EDITOR_COMMENTS_COLOR)
		elif style == LexerTikZ.Command: # LaTeX commands prefixed by \
			color = QColor(globals.editor.EDITOR_KEYWORDS_COLOR)
		elif style == LexerTikZ.Text: # Rest of the source
			color = QColor(globals.editor.EDITOR_TEXT_COLOR)
		return color
	...
	def defaultFont(self, style):
		...
		if style == LexerTikZ.Default: # LaTeX comments (without leading %)
			font.setBold(globals.editor.EDITOR_COMMENTS_BOLD)
			font.setItalic(globals.editor.EDITOR_COMMENTS_ITALIC)
		elif style == LexerTikZ.Special: # Symbols ()[]<>
			font.setBold(globals.editor.EDITOR_SYMBOLS1_BOLD)
			font.setItalic(globals.editor.EDITOR_SYMBOLS1_ITALIC)
		elif style == LexerTikZ.Group: # Symbols {}
			font.setBold(globals.editor.EDITOR_SYMBOLS2_BOLD)
			font.setItalic(globals.editor.EDITOR_SYMBOLS2_ITALIC)
		elif style == LexerTikZ.Symbol: # Leading % of LaTeX comments
			font.setBold(globals.editor.EDITOR_COMMENTS_BOLD)
			font.setItalic(globals.editor.EDITOR_COMMENTS_ITALIC)
		elif style == LexerTikZ.Command: # LaTeX commands prefixed by \
			font.setBold(globals.editor.EDITOR_KEYWORDS_BOLD)
			font.setItalic(globals.editor.EDITOR_KEYWORDS_ITALIC)
		elif style == LexerTikZ.Text: # Rest of the source
			font.setBold(globals.editor.EDITOR_TEXT_BOLD)
			font.setItalic(globals.editor.EDITOR_TEXT_ITALIC)
		return font
