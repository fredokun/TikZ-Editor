...
class PreviewPreferencesView(QWidget):
	...
	def __init__(self, parent=None):
		...
		self.preview_template_editor = tikz_editor.views.editor.EditorView()
	...
	def _initLayout(self):
		...
		layout.addWidget(tikz_editor.views.factory.ViewFactory.createLineSeparator(), 3, 0, 1, 3)
		...
		layout.addWidget(tikz_editor.views.factory.ViewFactory.createLineSeparator(), 7, 0, 1, 3)
